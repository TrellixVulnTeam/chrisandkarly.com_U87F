...
<div class="container">
    <div class="row text-xs-center text-sm-center">
        <div class="col-xs-12 text-center">
            <br>
            <h2 class="questrial dkblue-text" align="center">
                Our Registry
            </h2>
        </div>    
        <div class="sponsor col-xs-6 col-sm-3 center">
            <p>
                <a href="#"><img class="align-middle" src="img/sub/sponsors/HeavyMetalConcepts.png" alt=""></a></p>
        </div>
        <div class="sponsor col-xs-6 col-sm-4 center">
            <p>
                <a href="#"><img class="align-middle" src="img/sub/sponsors/Falken.png" alt=""></a></p>
        </div>
        <div class="sponsor col-xs-6 col-sm-3 center">
            <p>
                <a href="#"><img class="align-middle" src="img/sub/sponsors/Raceline.png" alt=""></a></p>
        </div>
        <div class="sponsor col-xs-6 col-sm-2 center">
            <p>
                <a href="#"><img class="align-middle" src="img/sub/sponsors/ECGS.png" alt=""></a></p>
        </div>
